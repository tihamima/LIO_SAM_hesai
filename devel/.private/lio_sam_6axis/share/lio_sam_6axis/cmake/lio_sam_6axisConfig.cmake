...
if(lio_sam_6axis_CONFIG_INCLUDED)
  return()
endif()
set(lio_sam_6axis_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(lio_sam_6axis_SOURCE_PREFIX /home/tihami/LIO_SAM_hesai/src/LIO-SAM-6AXIS)
  set(lio_sam_6axis_DEVEL_PREFIX /home/tihami/LIO_SAM_hesai/devel/.private/lio_sam_6axis)
  set(lio_sam_6axis_INSTALL_PREFIX "")
  set(lio_sam_6axis_PREFIX ${lio_sam_6axis_DEVEL_PREFIX})
else()
  set(lio_sam_6axis_SOURCE_PREFIX "")
  set(lio_sam_6axis_DEVEL_PREFIX "")
  set(lio_sam_6axis_INSTALL_PREFIX /home/tihami/LIO_SAM_hesai/install)
  set(lio_sam_6axis_PREFIX ${lio_sam_6axis_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lio_sam_6axis' is deprecated")
...
set(lio_sam_6axis_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/tihami/LIO_SAM_hesai/devel/.private/lio_sam_6axis/include;/home/tihami/LIO_SAM_hesai/src/LIO-SAM-6AXIS/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(lio_sam_6axis_INCLUDE_DIRS "")
  set(_include_dirs "/home/tihami/LIO_SAM_hesai/devel/.private/lio_sam_6axis/include;/home/tihami/LIO_SAM_hesai/src/LIO-SAM-6AXIS/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${lio_sam_6axis_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lio_sam_6axis' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lio_sam_6axis' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tihami/LIO_SAM_hesai/src/LIO-SAM-6AXIS/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lio_sam_6axis_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND lio_sam_6axis_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND lio_sam_6axis_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT lio_sam_6axis_NUM_DUMMY_TARGETS)
      set(lio_sam_6axis_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lio_sam_6axis::wrapped-linker-option${lio_sam_6axis_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lio_sam_6axis_NUM_DUMMY_TARGETS "${lio_sam_6axis_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lio_sam_6axis::wrapped-linker-option${lio_sam_6axis_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lio_sam_6axis_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tihami/LIO_SAM_hesai/devel/.private/lio_sam_6axis/lib;/home/tihami/LIO_SAM_hesai/devel/lib;/home/tihami/data_management/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(lio_sam_6axis_LIBRARY_DIRS ${lib_path})
      list(APPEND lio_sam_6axis_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lio_sam_6axis'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lio_sam_6axis_LIBRARIES ${lib})
    endif()
  endif()
...
set(lio_sam_6axis_EXPORTED_TARGETS "lio_sam_6axis_generate_messages_cpp;lio_sam_6axis_generate_messages_eus;lio_sam_6axis_generate_messages_lisp;lio_sam_6axis_generate_messages_nodejs;lio_sam_6axis_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lio_sam_6axis_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 lio_sam_6axis_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lio_sam_6axis_dep}_FOUND)
      find_package(${lio_sam_6axis_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lio_sam_6axis_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lio_sam_6axis_INCLUDE_DIRS ${${lio_sam_6axis_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lio_sam_6axis_LIBRARIES ${lio_sam_6axis_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lio_sam_6axis_dep}_LIBRARIES})
  _list_append_deduplicate(lio_sam_6axis_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lio_sam_6axis_LIBRARIES ${lio_sam_6axis_LIBRARIES})

  _list_append_unique(lio_sam_6axis_LIBRARY_DIRS ${${lio_sam_6axis_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(lio_sam_6axis_EXPORTED_TARGETS ${${lio_sam_6axis_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "lio_sam_6axis-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lio_sam_6axis_DIR}/${extra})
  endif()
  include(${extra})
endforeach()

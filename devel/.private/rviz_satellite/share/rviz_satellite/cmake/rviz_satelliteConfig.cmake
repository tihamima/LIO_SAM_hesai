...
if("TRUE" STREQUAL "TRUE")
  set(rviz_satellite_SOURCE_PREFIX /home/tihami/LIO_SAM_hesai/src/rviz_satellite)
  set(rviz_satellite_DEVEL_PREFIX /home/tihami/LIO_SAM_hesai/devel/.private/rviz_satellite)
  ...
  set(rviz_satellite_INSTALL_PREFIX /home/tihami/LIO_SAM_hesai/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_satellite' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tihami/LIO_SAM_hesai/src/rviz_satellite/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tihami/LIO_SAM_hesai/devel/.private/rviz_satellite/lib;/home/tihami/LIO_SAM_hesai/devel/lib;/home/tihami/data_management/devel/lib;/opt/ros/noetic/lib)
